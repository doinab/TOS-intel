 ...
 * Port P5
 */
extern int nondet_bv();

unsigned char _P5IN;     /* 0x0030 Input                 */
unsigned char _P5OUT = nondet_bv();    /* 0x0031 Output                */
 ...
 * ADC12
 */
unsigned short _ADC12IV = nondet_bv();        /* 0x01A8 Interrupt-vector-word register */
unsigned short _ADC12IE = nondet_bv();        /* 0x01A6 Inerrupt-enable register       */
unsigned short _ADC12IFG = nondet_bv();       /* 0x01A4 Inerrupt-flag register */
unsigned short _ADC12CTL1 = nondet_bv();      /* 0x01A2 Control register 1     */
unsigned short _ADC12CTL0 = nondet_bv();      /* 0x01A0 Control register 0     */
