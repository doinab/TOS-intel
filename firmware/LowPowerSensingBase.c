...
} __attribute__((packed)) nx_sensor_sample_t;
...
typedef nx_struct serial_request_samples_msg {
  nx_am_addr_t addr;
  nx_uint32_t sample_num;
} __attribute__((packed)) serial_request_samples_msg_t;


#line 56
typedef nx_struct request_samples_msg {
} __attribute__((packed)) request_samples_msg_t;
...
} __attribute__((packed)) sample_msg_t;
...
typedef nx_struct serial_sample_msg {
  ...
  nx_sensor_sample_t sample;
} __attribute__((packed)) serial_sample_msg_t;
